    ...
    'socials': async () => {
      pushToHistory(
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          <a className="ml-3 text-green-500" href='https://github.com/YusufHosny/'>
        ...
        <a className="ml-3 text-green-500" href='https://www.linkedin.com/in/yusuf-hussein-75956323b/'>
          <svg
            fill="currentColor"
            stroke="currentColor"
            strokeLinecap="round"
